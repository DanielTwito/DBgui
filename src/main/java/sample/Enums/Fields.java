...
public enum Fields {userName, password, birthDate, firstName, lastName,Email, hometown,image,airline,FlightDate,Returndate,baggage,adultTickets,childTickets,babyTickets
